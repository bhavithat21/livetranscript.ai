import type { LineRect } from './inline/geometry'
...
export type FileObservation = { path: string; language: string; startLine: number | null; lines: string[]; confidence: number; endOfFile: boolean; lineRects?: LineRect[] }
